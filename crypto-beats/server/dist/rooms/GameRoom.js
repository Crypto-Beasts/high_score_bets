...
const GameRoomState_1 = require("./GameRoomState");
class GameRoom extends colyseus_1.Room {
    onCreate(options) {
        ...
        // Handle messages
        this.onMessage("scoreUpdate", (client, message) => {
    ...
    onJoin(client, options) {
        ...
        if (!player) {
            ...
            player = new GameRoomState_1.PlayerSchema();
    ...
    handleScoreUpdate(client, message) {
    ...
    handleGameEnd(client, message) {
        ...
        if (allFinished) {
            ...
            const winner = players.reduce((prev, curr) => (curr.finalScore || 0) > (prev.finalScore || 0) ? curr : prev);
